...
die('只能是英文數字<br>' . '<a href="./register.input.php">回到上層重新登入</a>');
// }else if ($password !== $assertpassword) {
//     die('兩次輸入的密碼不同<br>' . '<a href="./register.input.php">回到上層繼續註冊</a>');
...
$sql = 'INSERT INTO member(id,username, name, email,password, created_at, updated_at) VALUES(NULL,:username, :name, :email,:password, sysdate(), sysdate())';
...
$sql_findID = "SELECT * FROM member WHERE username = '" . $_POST['username'] . "'";
...
// $_SESSION['assertpassword'] = $user['assertpassword'];
